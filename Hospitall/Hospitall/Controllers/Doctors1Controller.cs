...
namespace Hospitall.Controllers
{
    public class Doctors1Controller : Controller
    {
        ...
        public Doctors1Controller(appdbcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DocID,Name,Specialty")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DocID,Name,Specialty")] Doctor doctor)
        {
            if (id != doctor.DocID)
            {
                return NotFound();
